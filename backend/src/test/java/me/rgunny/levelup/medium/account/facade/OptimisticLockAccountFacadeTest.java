...
//        accountVersionJpaRepository.deleteAllInBatch();
//        entityManager.createNativeQuery("TRUNCATE TABLE accounts_version").executeUpdate();
//        entityManager.createNativeQuery("SELECT * FROM accounts_version").executeUpdate();
//        entityManager.createNativeQuery("ALTER TABLE ACCOUNTS_VERSION ALTER COLUMN ID RESTART WITH 1").executeUpdate();
    }
