...
import me.rgunny.levelup.account.facade.NamedLockAccountFacade;
...
@SpringBootTest
@ActiveProfiles("test")
public class NamedLockAccountFacadeTest {

    @Autowired
    private DatabaseCleanup databaseCleanup;

    @Autowired
    private NamedLockAccountFacade namedLockAccountFacade;
    ...
    @DisplayName("동시에 100번 출금할 경우 Named lock을 사용한 동시성 제어를 위한 CompletableFuture 사용한 성공 테스트 ")
    @Test
    void withdrawUsingNamedLockConcurrentTest2() throws InterruptedException {
        // given
